...
class KmlContainerParser {
  ...
  private static final String PROPERTY_REGEX =
      "name|description|visibility|open|address|phoneNumber";
  ...
  private static final String UNSUPPORTED_REGEX =
  ...
  /**
   * Creates a new KmlContainer objects and assigns specific elements read from the XmlPullParser to
   * the new KmlContainer.
   *
  ...
  /**
   * Assigns properties given as an extended data element, which are obtained from an XmlPullParser
   * and stores it in a container, Untyped data only, no simple data or schema, and entity
   * replacements of the form $[dataName] are unsupported.
   */
  private static void setExtendedDataProperties(
      XmlPullParser parser, HashMap<String, String> mContainerProperties)
      throws XmlPullParserException, IOException {
  ...
  /**
   * Creates a new placemark object and assigns specific elements read from the XmlPullParser to the
   * Placemark and stores this into the given Container.
   */
  private static void setContainerPlacemark(
      XmlPullParser parser, HashMap<KmlPlacemark, Object> containerPlacemarks)
      throws XmlPullParserException, IOException {
