...
public class KmlStyle extends Style {
  ...
  @VisibleForTesting float mMarkerColor;
  ...
  /**
   * Converts a color format of the form AABBGGRR to AARRGGBB. Any leading or trailing spaces in the
   * provided string will be trimmed prior to conversion.
   *
  ...
  /**
   * Sets the color mode for a marker. A "random" color mode sets the color mode to true, a "normal"
   * colormode sets the color mode to false.
   *
  ...
  /**
   * Sets the color mode for a polyline. A "random" color mode sets the color mode to true, a
   * "normal" colormode sets the color mode to false.
   *
   * @param colorMode A "random" or "normal" color mode
   */
  ...
  /**
   * Sets the color mode for a polygon. A "random" color mode sets the color mode to true, a
   * "normal" colormode sets the color mode to false.
   *
   * @param colorMode A "random" or "normal" color mode
   */
  ...
  private static MarkerOptions createMarkerOptions(
      MarkerOptions originalMarkerOption, boolean iconRandomColorMode, float markerColor) {
   ...
   */
  private static PolygonOptions createPolygonOptions(
      PolygonOptions originalPolygonOption, boolean isFill, boolean isOutline) {
